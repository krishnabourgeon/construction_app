...
// //     await prefs.remove("show_payment_popup");
...
// //   if(showPaymentPopup != null){
// //     await prefs.setBool('show_payment_popup', showPaymentPopup);
// //   }
// //   log('SAVED TRIAL: daysLeft=$daysLeft, expired=$expired, showPaymentPopup=$showPaymentPopup');
// // }
...
// // static Future<bool> getShowPaymentPopup() async {
// //   final prefs = await SharedPreferences.getInstance();
// //   return prefs.getBool('show_payment_popup') ?? false;
// // }
...
//     log('SAVED SUBSCRIPTION STATUS: $status');
//   }
