...
//   final _companyTypeCtrl = TextEditingController();
...
//   //   if (!mounted) return;
//   //   _showSnack('Company registered successfully!', AppColors.green);
//   // }
...
//                                 : FontWeight.w400,
//                             color:
//                                 active ? AppColors.dark : AppColors.grey,
//                           )),
//                       if (i < steps.length - 1)
//                         Container(
//                           height: 2,
...
//   //         border: Border.all(
//   //             color: AppColors.amber, style: BorderStyle.solid, width: 1.5),
//   //       ),
//   //       child: Column(
//   //         children: [
//   //           Container(
...
//               hintText: hint,
//               hintStyle: GoogleFonts.poppins(fontSize: 13, color: AppColors.greyLight),
...
//                 borderRadius: BorderRadius.circular(10),
//                 borderSide:
//                     const BorderSide(color: AppColors.amber, width: 1.8)),
//             errorBorder: OutlineInputBorder(
//                 borderRadius: BorderRadius.circular(10),
//                 borderSide: const BorderSide(color: AppColors.red)),
//           ),
...
class CompanyRegisterScreen extends StatefulWidget {
  ...
  const CompanyRegisterScreen({super.key, this.onSuccess, required this.companyID,required this.regtoken});
...
class _CompanyRegisterScreenState extends State<CompanyRegisterScreen> {
  ...
  void _submit() async {
    ...
    final registerCompanyBody = RegisterCompanyBody(
